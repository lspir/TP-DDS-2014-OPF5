...
import static db.EntityManagerHelper.beginTransaction;
import static db.EntityManagerHelper.rollback;
...
public class TestOPF5 {
	...
	public void setUp() {
		...
		partidoCon5Estandares = new Partido(LocalDate.now(), LocalTime.now(),
				"Campus");
		partidoCon10Solidarios = new Partido(LocalDate.now().plusDays(10),
				LocalTime.now(), "Campus");
		partidoLleno = new Partido(LocalDate.of(2014, Month.AUGUST, 13),
				LocalTime.of(12, 30), "Campus");
		partidoCon8Estandares1Solidario1Condicional = new Partido(LocalDate.of(
				2014, Month.APRIL, 29), LocalTime.of(21, 30), "Campus");
		partidoCon1Estandar = new Partido(LocalDate.of(2014, Month.AUGUST, 29),
				LocalTime.of(20, 00), "Mario Bravo");
		...
		partidoCon8Estandares1Solidario1Condicional
				.agregarObservador(observadorAdmin);
		partidoCon8Estandares1Solidario1Condicional
				.agregarObservador(observadorJugador);
		...
		this.cargarPartido(partidoCon8Estandares1Solidario1Condicional,
				estandar, 8);
		partidoCon8Estandares1Solidario1Condicional
				.intentarInscribirA(inscripcionSolidario);
		partidoCon8Estandares1Solidario1Condicional
				.intentarInscribirA(inscripcionCondicional);
	...
	private void cargarPartido(Partido partido,
			TipoDeInscripcion tipoDeinscripcion, int cantidadJugadores) {
		for (int i = 0; i < cantidadJugadores; i++) {
			Inscripcion inscripcion = new Inscripcion(new Jugador("nombre", 20,
					10), tipoDeinscripcion);
